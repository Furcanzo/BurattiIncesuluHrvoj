...
\subsubsection{Schedule Emergency Stop} % TODO: Schedule and Stop are essentially the same thing, so make it one?
...
Upon trigger of the button, the CLup Application shows the editing form for the general information about the store, with the current values already prefilled.
...
Once the updated message is retrieved from the DBMS, the message propogates through the calls and a success screen is shown to the manager.
% TODO: Ozan End
% Clerk
