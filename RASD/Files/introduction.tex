...
% Set the in-shop location and availability info on different products or categories of products in the location
...
% Print line numbers with QR codes on them for the physically arriving customers who doesn't have a virtual ticket


% User:
% Retrieve a direct line number
...
% Record the amount of people in the store
