...
% TODO: @Ozan if found detail everything. If not write dependencies, constraints whatever...

% TODO: All: Refine the RASD analysis and send them through mediums.
...
% Enter manually the line number, customer info to the system to invalidate customers. % TODO: Shall we remove?
...
% TODO: @Ozan switch tables from DrawIO to Latex
...
\begin{itemize}
    ...
    \item \textit{Maps}: Google Maps API that is used as a mapping service
\end{itemize}
...
\begin{itemize}
    ...
    \item \href{https://developers.google.com/maps/documentation/javascript/overview}{Maps documentation}
\end{itemize}
