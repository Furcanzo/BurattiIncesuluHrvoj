...
% Set the categories of interest before visit for finer granularity.
...
\textbf{Super User:} \\
In order to use the CLup application, store or buisness owners should contact CLup Super User who will give them permission to use the application and create a Manager account for them.
...
\begin{itemize}
    ...
    \item \textit{Clerk}: A person in charge of handling the entrance and exit of customers
