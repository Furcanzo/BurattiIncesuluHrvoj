...
\begin{itemize}
    ...
    \item \textbf{$R_3$} The system must provide a hard-coded super user to allow addition of locations and managers of locations. % TODO: Remove
    ...
    \item \textbf{$R_{28}$} Customers can view their line numbers with the number and the QR code. % TODO: Remove
...
\begin{table}[H]
    \begin{tabular}{|p{8cm}|p{8cm}|}
        ...
        & Schedule a Stop \\
        & Stop for Emergency\\ \hline
        $R_{20}$ & Retrieve Line Number \\ \hline
