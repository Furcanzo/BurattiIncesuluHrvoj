...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/UseCaseDiagrams/Customer.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/Customer/BookFutureLineNumberUseCaseSequenceDiagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/Customer/SeeAmountOfCustomersInStoreUseCaseSequenceDiagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/Customer/SeeStoreLocationUseCaseSequenceDiagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/Customer/SignUpUseCaseSequenceDiagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/LogInUseCaseSequenceDiagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/Customer/NotifyTicketDeleteUseCaseSequenceDiagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/UpdateUserInformationUseCaseSequenceDiagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/UseCaseDiagrams/Clerk.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/Clerk/GrantAccessUseCaseSequenceDiagram.png}
    \caption{Sequence Diagram for Use Case: Update user information}
\end{figure}
\begin{table}[H]
    \begin{tabular}{|p{8cm}|p{8cm}|}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/Clerk/PrintGuestTicketUseCaseSequenceDiagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/UseCaseDiagrams/Manager.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/Manager/SetStoreInfoUseCaseSequenceDiagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/Manager/MonitorStateUseCaseSequenceDiagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/Manager/ScheduleAStopUseCaseSequenceDiagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/Manager/StopForEmergencyUseCaseSequenceDiagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/Manager/AddClerkUseCaseSequenceDiagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textwidth]{Images/SequenceDiagrams/Manager/AddManagerUseCaseSequenceDiagram.png}
